...
export default function Index() {
  return (
    <>
      <div className="justify-center text-center flex flex-wrap mt-24 custom-txt-title py-24">
        <a>
        Edit Profile
        </a>
      </div>
            ...
            <div class="px-6">
              <div class="relative px-6">
                <label className="block custom-txt-title text-sm mb-1" for="grid-password">
                  ...
                  <input type="text" class="border-0 px-3 py-3 placeholder-transparent text-blueGray-600 bg-black custom-txt-title uppercase rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="demo mint it">
                    </input>
              </div>
            </div>
            ...
            <div class=" md:w-4/12 pl-10">
              <div class="relative pl-10">
                <label className="block custom-txt-title text-sm mb-1 " for="grid-password">
                  ...
                  <input type="text" class=" border-0 px-3 py-3 placeholder-transparent text-blueGray-600 bg-black custom-txt-title rounded text-sm shadow focus:outline-none focus:ring  ease-linear transition-all duration-150" value="Manufacturer">
                    </input>
