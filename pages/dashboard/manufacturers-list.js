...
export default function Index() {
	...
	const getManufacturers = () => {
		const q = query(collection(db, "verification-proposals"), where("status", "==", "approved"));
	...
	return (
		<>
			<div className="mx-4 mt-48 px-12">
				<div className="justify-center text-center w-full flex flex-wrap mt-24 custom-txt-title pt-0 text-white">List of Verified Manufacturers</div>
