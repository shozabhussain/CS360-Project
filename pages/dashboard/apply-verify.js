...
export default function Index() {
	...
	const submitData = () => {
		...
		promiseList.push(uploadFiles(llcFile, "LLC"));
		promiseList.push(uploadFiles(tradeMarkFile, "Trademark"));
			...
			<section className="pt-48 pb-40 text-white">
				<div className="justify-center text-center flex flex-wrap mt-24">
					...
					>
						...
						<div className="flex flex-wrap">
							<div className="w-full lg:w-6/12 px-4">
								<div className="relative w-full mb-3">
									<label className="block uppercase text-warmGray-100 text-xs font-bold mb-2" htmlFor="grid-password">
						...
						<h6 className="text-blueGray-300 text-sm mt-3 mb-6 font-bold uppercase">Upload Files</h6>
						<div className="flex flex-wrap">
							...
							<div className="w-full  px-4">
								<div className="relative justify-center items-center  mt-3">
									<input required type="submit" className="border-0 px-3 w-1/6 bg-yellow-500 text-black py-3 rounded text-sm shadow focus:outline-none focus:ring ease-linear transition-all duration-150" />
								</div>
							</div>
						</div>
					</form>
