      ...
      <nav className="relative z-10 flex flex-wrap items-center justify-between px-6 py-4 bg-white shadow-xl md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden md:w-64">
        <div className="flex flex-wrap items-center justify-between w-full px-0 mx-auto md:flex-col md:items-stretch md:min-h-full md:flex-nowrap">
		  ...
		  <div className="w-full flex flex-wrap mt-4">
			  <div>
			  <img src="/img/sideLogo.png" className="h-20"></img>
			  </div>
			<Link href="/">
            <a
              href="/dashboard"
              className="inline-block p-8 px-8 text-right text-sm md:block md:pb-2 custom-txt-title whitespace-nowrap justify-center items-center"
            >
              Mint it
            </a>
          </Link>
                ...
                <Link href="/dashboard/track">
                  <a
                    ...
                    className={
                      ...
                      (router.pathname.indexOf("/dashboard/track") !== -1
              ...
              <li className="items-center">
                <Link href="/dashboard/view-nfts">
                  <a
                    ...
                    className={
                      "text-sm py-3 font-bold block custom-txt-title " +
                      (router.pathname.indexOf("/dashboard/view-nfts") !== -1
                        ? "text-custom-bg-darkblue hover:custom-bg-darkblue"
                        : "text-custom-bg-darkblue hover:text-blueGray-500")
                    }
                  >
              ...
              <li className="items-center">
                <Link href="/dashboard/mint-nft">
                  <a
                    ...
                    className={
                      "text-sm py-3 font-bold block custom-txt-title " +
                      (router.pathname.indexOf("/dashboard/mint-nft") !== -1
                        ? "text-custom-bg-darkblue hover:custom-bg-darkblue"
                        : "text-custom-bg-darkblue hover:text-blueGray-500")
                    }
                  >
              ...
              <li className="items-center">
                <Link href="/dashboard/transactions">
                  <a
                    ...
                    className={
                      "text-sm py-3 font-bold block custom-txt-title " +
                      (router.pathname.indexOf("/dashboard/transactions") !== -1
                        ? "text-custom-bg-darkblue hover:custom-bg-darkblue"
                        : "text-custom-bg-darkblue hover:text-blueGray-500")
                    }
                  >
